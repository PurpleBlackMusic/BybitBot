...
st.page_link(
    "app.py",
    label="🔧 Перейти в расширенный режим",
    help="Откроет полный интерфейс со всеми настройками и инструментами.",
)

st.info(
    "В расширенном режиме доступны детальные отчёты, настройки и дополнительные инструменты. "
    "Вы можете свободно переключаться между режимами — фоновые сервисы общие для всего приложения.",
    icon="ℹ️",
)
